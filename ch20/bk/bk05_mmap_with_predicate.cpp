...
typedef map<string, string, PredIgnoreCase> DIR_NO_CASE;
...
int main()
{
    ...
    DIR_NO_CASE dirNoCase(dirWithCase.begin(), dirWithCase.end());
    ...
    if (pairNoCase != dirNoCase.end())
        cout << "Num found in case-insensitive dir: " << pairNoCase->second << endl;
    else
...
// Num found in case-insensitive dir: 32435348
...
// Please enter a name to search
// > Jack
// Num in case-insensitive dir: 32435348
// Num found in case-insensitive dir: 32435348
